...
void log_packet(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Ljlab/firewall/vpn/Packet;)V";
...
void dns_resolved(const struct arguments *args,
    ...
    const char *signature = "(Ljlab/firewall/vpn/ResourceRecord;)V";
...
struct allowed *is_address_allowed(const struct arguments *args, jobject jpacket) {
    ...
    const char *signature = "(Ljlab/firewall/vpn/Packet;)Ljlab/firewall/vpn/Allowed;";
...
void account_usage(const struct arguments *args, jint version, jint protocol,
    ...
    const char *signature = "(Ljlab/firewall/vpn/Usage;)V";
...
JNIEXPORT void JNICALL
Java_jlab_firewall_vpn_FirewallService_jni_1start(JNIEnv *env, jobject thiz, jlong context,
                                                  jint loglevel) {
    Java_eu_faircode_netguard_ServiceSinkhole_jni_1start(env, thiz, context, loglevel);
}

JNIEXPORT void JNICALL
Java_jlab_firewall_vpn_FirewallService_jni_1run(JNIEnv *env, jobject thiz, jlong context, jint tun,
                                                jboolean fwd53, jint rcode) {
    Java_eu_faircode_netguard_ServiceSinkhole_jni_1run(env, thiz, context, tun, fwd53, rcode);
}

JNIEXPORT void JNICALL
Java_jlab_firewall_vpn_FirewallService_jni_1stop(JNIEnv *env, jobject thiz, jlong context) {
    Java_eu_faircode_netguard_ServiceSinkhole_jni_1stop(env, thiz, context);
}

JNIEXPORT void JNICALL
Java_jlab_firewall_vpn_FirewallService_jni_1clear(JNIEnv *env, jobject thiz, jlong context) {
    Java_eu_faircode_netguard_ServiceSinkhole_jni_1clear(env, thiz, context);
}